...
##=================================================================================
WRF_namelist_input_file_path=/student/home/Burhan/Build_WRF/WRF/test/em_real/namelist.input
MOZBC_directory_path=/student/home/Burhan/Build_WRF/mozbc
WACCM_data_file_name=waccm-20250206052354913665.nc
##=================================================================================
...
read_namelist_var() {
    var=$1
    echo grep -i "^\s*$var\s*=" $WRF_namelist_input_file_path | awk -F= '{print $2}' | tr -d ' ,' | head -n 1
...
ncl_filedump $wrfdir/wrfinput_d01.nc | awk '/Variable: / {var=$2}/Type: float/ {print var}' > wrfinput_vars.txt
ncl_filedump $WACCM_data_file_name | grep float > waccm_vars.txt


#echo "burhan".$wrfdir
#ncl_filedump $wrfdir/wrfinput_d01.nc | grep float
#ncl_filedump $wrfdir/wrfinput_d01.nc | awk '/Variable: / {var=$2}/Type: float/ {print var}'
#ncl_filedump $wrfdir/wrfinput_d01.nc | awk '/float / {print $2}' > wrfinput_vars.txt
#ncl_filedump $wrfdir/wrfinput_d01.nc | grep -E "^[ ]{2}[a-zA-Z0-9_]+ =" | awk '{print $1}'
