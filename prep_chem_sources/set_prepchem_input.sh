#!/bin/bash
#Contact person: Amirhossein Nikfal <https://github.com/burhangis>

# Paths to Global_emissions and namelist.wps, and namelist.input (optional)
#=====================================================================================
global_emissions=/home/burhan/Global_emissions_v3
namelist_wps=/home/burhan/WRFTEST/WPS/namelist.wps
namelist_input=/home/burhan/WRFTEST/WRF/test/em_real/namelist.input
#-------------------------------------------------------------------------------------
